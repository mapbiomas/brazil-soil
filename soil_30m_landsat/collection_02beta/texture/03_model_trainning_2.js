...
var steps = [
  { matrix: 'psd_c02beta_010_020cm_v2', version: 'v2', profundidade_alvo: '010_020cm', target_depth: 'depth_15'}
];
...
var selected_prev_prediction = [
//MapBiomas Soil previews prediction
  'clay_000_010',
  'sand_000_010',
  'silt_000_010',
];
...
// --- STATIC
var new_static_image = ee.Image.cat(static_covariates.select(selected_prev_prediction));
print(new_static_image, "new covariates");

var static_covariates = new_static_image;
var new_covariates = new_static_image.select(selected_prev_prediction);

// Sampling the training data
var sampledTraining = new_covariates.sampleRegions({
  collection: datatraining,
  properties: datatraining_columns,
  scale: 30,
  geometries: true
});

print('Final data training', sampledTraining.limit(10));
