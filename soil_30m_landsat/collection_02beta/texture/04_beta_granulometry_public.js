 ...
 * 
 * PUBLIC SCRIPT: PREDICTING AND MAPPING SOIL GRANULOMETRY (CLAY, SAND, SILT)
 * 
 * **Purpose**:
...
// var profundidade_alvo = '_0_10cm'
// var target_depth = 'depth_5'

//////////////     10-20 cm
//var version = 'v010_10_20cm'; 
//var profundidade_alvo = '_10_20cm'
//var target_depth = 'depth_15'

//////////////     20-30 cm
var version = 'v010_20_30cm'; 
var profundidade_alvo = '_20_30cm'
 var target_depth = 'depth_25'


///////////////////////////////////////////////////////////////////////////////////////////
// --- DEFINITION OF DATA FOR PREDICTION
var matrix = 'projects/mapbiomas-workspace/SOLOS/AMOSTRAS/MATRIZES/granulometry/matriz-' + version;
...
// Rename target depth to 'depth'
var renamed_static_covariates = static_covariates.rename(
  static_covariates.bandNames().replace(target_depth, 'depth')
);
...
var final_images = [
  [version + '_prediction_sand'+ profundidade_alvo, map_sand],
  [version + '_prediction_silt'+ profundidade_alvo, map_silt],
  [version + '_prediction_clay'+ profundidade_alvo, map_clay],
];
...
var dict = randomForestModel_ln_silt_sand.explain();
